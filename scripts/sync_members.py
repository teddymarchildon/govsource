#!/usr/bin/env python3
"""
Script to sync members of Congress from the Congress API to the database.
"""
import argparse
import logging
import sys
...
from app.services.congress_api import sync_members
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Sync members from the Congress API")
    ...
    try:
        ...
        while remaining_limit > 0 or args.limit == -1:
            ...
            members = sync_members(db, limit=batch_size, offset=current_offset)
